...
namespace HeBianGu.Product.WCFRemote.General.WindowService
{
    ...
    public partial class SystemWindowService
    {
        public static SystemWindowService Instance = new SystemWindowService();
        ...
        {
            System.Drawing.Bitmap bitmap = this.GetScreem();
        ...
        public System.Drawing.Bitmap PrintScreem(int width, int height)
        {
            //获得当前屏幕的大小 
